  ...
  return (
    <footer className="bg-[#000]">
      <div className="pt-[80px] pb-[60px] border-b-[1px] border-b-[#141414]">
        <div className="container max-w-[1170px] mx-auto px-4 md:px-6">
          <div className="flex flex-wrap gap-8 md:gap-12 justify-between">
            <div className="w-full sm:w-[217px]">
              <Link to={"/"}>
              ...
              <input
                className="w-full rounded-[4px] border-[1px] border-[#fff] bg-transparent py-[12px] px-[16px] placeholder:text-[#575757] text-[#fff]"
                type="email"
            ...
            <div className="w-full sm:w-auto text-center sm:text-left">
              ...
              <img
                className="mb-[24px] mx-auto sm:mx-0"
                src={Image}
                alt="image"
              />
              <div className="flex justify-center sm:justify-start items-center gap-[24px]">
                <a href="#">
                  <FacebookIcon />
                </a>
                <a href="#">
