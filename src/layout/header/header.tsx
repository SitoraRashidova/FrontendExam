...
export const Header = () => {
    ...
    return (
        <header>
            <div className="bg-[#000] py-[12px] text-center px-4">
                <div className="container max-w-[1170px] mx-auto">
                    <p className="font-normal text-[#fafafa] text-[14px] leading-[150%]">
                        Summer Sale For All Swim Suits And Free Express Delivery - OFF 50%!
                    </p>
                </div>
            </div>
            <div className="py-[28px] border-b-[1px] border-b-[#B3B3B3] px-4">
                <div className="container max-w-[1170px] mx-auto">
                    <div className="flex items-center justify-between">
                        <Link className="font-bold text-[24px]" to={"/"}>
                            Exclusive
                        </Link>
                        <div className="hidden md:flex gap-[24px] lg:gap-[48px]">
