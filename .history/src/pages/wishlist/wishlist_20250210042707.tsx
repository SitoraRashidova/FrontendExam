...
export const Card = ({ id, thumbnail, title, rating, price }: ProductType) => {
  ...
  return (
    <div className="w-[270px] sm:w-[220px] md:w-[240px] lg:w-[270px]">
      ...
      <Link to={`/products/${id}`}>
        <h3 className="font-medium text-[16px] mb-[8px] sm:text-[14px] md:text-[15px] lg:text-[16px]">
          {title}
        </h3>
      </Link>
      <div className="flex gap-[10px]">
        <p className="font-medium text-[16px] text-[#db4444] sm:text-[14px] md:text-[15px] lg:text-[16px]">
          ${price}
        </p>
