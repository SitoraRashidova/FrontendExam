export const Profile = () => {
  return (
    <div className="container max-w-[1170px] mx-auto px-4">
      <div className="flex flex-col lg:flex-row gap-8 max-w-4xl mx-auto mt-10">
        {/* Sidebar */}
        <aside className="w-full lg:w-1/4 bg-white p-4 shadow-md rounded-lg text-center lg:text-left">
