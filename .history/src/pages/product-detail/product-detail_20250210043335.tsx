      ...
      {isLoading ? (
        ...
        <div className="flex justify-between">
          ...
          <div className="w-[400px]">
            <h2 className="font-semibold text-[24px] mb-[16px]">
              {data?.title}
            </h2>
            <p className="font-normal text-[24px] mb-[24px]">${data?.price}</p>
            <p className="font-normal text-[14px] pb-[24px] border-b-[1px] border-b-[#808080] mb-[24px]">
              {data?.description}
            </p>
            <div className="flex justify-between mb-[40px]">
              <div className="border-[#808080] border-[1px] rounded-[4px] flex justify-between items-center w-[160px] h-[44px]">
                <button className="w-[40px] border-r-[#808080] border-r-[1px] text-[28px] font-semibold">
                  -
                </button>
                <p className="font-medium text-[20px]">1</p>
                <button className="w-[40px] bg-[#DB4444] text-[#fff] text-[28px] font-semibold">
                  +
                </button>
              </div>
              <button className="rounded-[4px] py-[10px] px-[48px] bg-[#DB4444] text-[#fff] text-[16px] font-semibold">
                Buy Now
              </button>
              <button
            ...
            <div className="border-[#808080] border-[1px] rounded-[4px]">
              <div className="pt-[24px] pl-[16px] pb-[16px] border-b-[#808080] border-b-[1px] flex items-center gap-[16px]">
                <DeliveryIcon />
                <div>
                  <p className="font-medium text-[16px] mb-[8px]">
                    Free Delivery
                  </p>
