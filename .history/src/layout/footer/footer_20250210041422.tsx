  ...
  return (
    <footer className="bg-black text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="space-y-4">
            <Link href="/" className="inline-block">
              <Image src="/images/Exclusive.svg" alt="Exclusive Logo" width={118} height={24} />
            </Link>
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs font-medium text-gray-300">Save $3 with App New User Only</p>
            <div className="flex space-x-4">
              <Image src="/images/qr-code.png" alt="QR Code" width={76} height={76} />
              <div className="flex flex-col justify-between">
                <Image src="/images/app-store.png" alt="App Store" width={110} height={32} />
                <Image src="/images/google-play.png" alt="Google Play" width={110} height={32} />
              </div>
            </div>
            <div className="flex space-x-4">
      ...
      <div className="container mx-auto px-4 py-6">
        <p className="text-center text-sm text-gray-500">&copy; Copyright Rimel 2022. All right reserved</p>
      </div>
    </footer>
  )
}
